...
export type LocatorTargetTypes =
  | 'USER';

export type LocatorTypes =
  | 'BARCODE'
  | 'RFID';
...
export type Query = {
  ...
  helloTerminal?: Maybe<Scalars['Boolean']>;
...
export type HelloTerminalQuery = { __typename?: 'Query', helloTerminal?: boolean | null };
...
export const HelloTerminalDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"HelloTerminal"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"helloTerminal"}}]}}]} as unknown as DocumentNode<HelloTerminalQuery, HelloTerminalQueryVariables>;
