...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/pos/error': RouteRecordInfo<'/pos/error', '/pos/error', Record<never, never>, Record<never, never>>,
    '/pos/register': RouteRecordInfo<'/pos/register', '/pos/register', Record<never, never>, Record<never, never>>,
    '/pos/setup': RouteRecordInfo<'/pos/setup', '/pos/setup', Record<never, never>, Record<never, never>>,
