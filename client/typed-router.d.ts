...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/users/[id]/': RouteRecordInfo<'/users/[id]/', '/users/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/users/[id]/badges': RouteRecordInfo<'/users/[id]/badges', '/users/:id/badges', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/users/[id]/invoices': RouteRecordInfo<'/users/[id]/invoices', '/users/:id/invoices', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/users/[id]/membership': RouteRecordInfo<'/users/[id]/membership', '/users/:id/membership', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/users/[id]/photo': RouteRecordInfo<'/users/[id]/photo', '/users/:id/photo', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/users/new': RouteRecordInfo<'/users/new', '/users/new', Record<never, never>, Record<never, never>>,
    '/volunteers/[[scope]]': RouteRecordInfo<'/volunteers/[[scope]]', '/volunteers/:scope?', { scope?: ParamValueZeroOrOne<true> }, { scope?: ParamValueZeroOrOne<false> }>,
